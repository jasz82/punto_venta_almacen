<div class="col-md-4 col-md-offset-4 col-xs-12">
	<h3 class="text-center">Bienvenido <br/> Almac&eacute;n "Don Mario" <i class="fa fa-smile-o"></i></h3>
	
	<?php
		$fecha_actual         = strtotime(date("d-m-Y H:i:s",time()));
		$fecha_vence_licencia = strtotime("30-04-2024 23:59:59");
		
		if($fecha_actual >= $fecha_vence_licencia){
	?>
			<div class="col-md-12">
				<div class="form-group">
					<h5 class="text-center">La licencia del Usuario esta Caducada</h5>
				</div>
			</div>
	<?php
		}else{
	?>
			<div class="col-md-12">
				<div class="form-group">
					<h6 class="text-center">La licencia de Usuario se encuentra Vigente</h6>
				</div>
			</div>
			<div class="col-md-12">
				<div class="form-group">
