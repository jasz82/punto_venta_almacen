    ...
    <div class="row">
        <div class="col-xs-12 col-md-4" id="contenedor_formulario">
            ...
            <div class="form-group">
                <label for="id_producto">Codigo de Barra</label>
            ...
            <div class="form-group">
                <label for="inventario">Cantidad en Stock</label>
...
<div id="modal_agregar_piezas" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="numero_piezas_agregar">Suma una nueva cantidad al Stock</label>
                    <input class="form-control" placeholder="Ingresa el número de Stock que quieres agregar"
...
<div id="modal_dar_baja" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="numero_piezas_baja">Ingresa el número de productos que quieres dar de baja</label>
                    <input class="form-control" placeholder="Ingresa el número de productos que quieres dar de baja"
