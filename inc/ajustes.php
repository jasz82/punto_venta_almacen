...
<div class="row">
    ...
    <div class="col-xs-12">
        ...
        <div class="form-group">
            <label for="rfc">Razon Social</label><input placeholder="RFC" type="text" id="rfc" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="colonia">Villa/Población</label><input placeholder="Colonia" type="text" id="colonia"
                                                       class="form-control">
        </div>
        <div class="form-group">
